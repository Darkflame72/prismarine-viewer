console.log("Loading mineflayer.js");
...
module.exports = (bot, { viewDistance = 6, firstPerson = false, port = 3000 }) => {
  ...
  io.on('connection', (socket) => {
    ...
    bot.on('message', (jsonMsg, position) => {
      socket.emit('chat', jsonMsg);
      console.log("Transmited chat message to client: " + jsonMsg);
      console.log("JSON encoded: " + JSON.stringify(jsonMsg)) // {"json":{"text":"mineweb.test"},"text":"mineweb.test"}
    })
